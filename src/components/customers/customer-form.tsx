...
export function CustomerForm({ customer }: { customer?: Customer }) {
  ...
  const [aadharImage, setAadharImage] = useState<{
    ...
    customer?.aadharImageUrl
      ? {
          url: customer.aadharImageUrl,
          publicId: customer.aadharImagePublicId || "",
        }
      : null,
  );
  const [drivingLicenseImage, setDrivingLicenseImage] = useState<{
    ...
    customer?.drivingLicenseImageUrl
      ? {
          url: customer.drivingLicenseImageUrl,
          publicId: customer.drivingLicenseImagePublicId || "",
        }
      : null,
  );
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="space-y-2">
          ...
          <Input
            ...
            defaultValue={customer?.drivingLicenseNumber}
            required
        ...
        <div className="space-y-2">
          ...
          <Select
            ...
            defaultValue={customer?.verificationStatus || "Pending"}
          >
            <SelectTrigger>
      ...
      <div className="space-y-4 pt-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <ImageUpload
            ...
            onUploadComplete={(url, publicId) =>
              setDrivingLicenseImage({ url, publicId })
            }
...
function SubmitButton({ isEdit }: { isEdit: boolean }) {
  ...
  return (
    <Button
      type="submit"
      disabled={pending}
      className="min-w-[120px] bg-[#7C3AED] hover:bg-[#6D28D9]"
    >
      {pending
        ? isEdit
          ? "Updating..."
