                ...
                <TooltipTrigger asChild>
                  <Link
                    ...
                    className={cn(
                      ...
                      isSidebarCollapsed
                        ? "w-10 mx-[14px] justify-center px-0 gap-0"
                        : "w-[calc(100%-24px)] mx-3 px-3 justify-start gap-3",
                      isActive
      ...
      <div className="p-3 border-t border-[#E8E5F0] dark:border-slate-800">
        ...
        >
          <Avatar className="h-9 w-9 shrink-0 ring-2 ring-[#F5F3FF] dark:ring-slate-800">
            ...
            <AvatarFallback className="bg-[#F5F3FF] dark:bg-violet-950/30 text-[#7C3AED] text-xs font-medium">
              KN
            </AvatarFallback>
          </Avatar>
          <div
          ...
          >
            <p className="text-sm font-medium text-[#1a1d2e] dark:text-white truncate leading-tight">
              Kavinnandha
            </p>
            <p className="text-xs text-[#94a3b8] truncate leading-tight mt-0.5">
              kavinnandha@carzio.com
            </p>
          </div>
        </div>
      </div>
