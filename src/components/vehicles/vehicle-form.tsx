        ...
        <form action={handleSubmit} className="space-y-6 max-w-5xl mx-auto bg-white dark:bg-slate-900 p-8 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                    ...
                    <Input id="model" name="model" defaultValue={vehicle?.model} required placeholder="Camry" />
                </div>
                <div className="space-y-2">
                    <Label htmlFor="year">Year</Label>
                    <Input id="year" name="year" type="number" defaultValue={vehicle?.year} required placeholder="2024" min="2000" max="2030" />
                </div>
                <div className="space-y-2">
                    <Label htmlFor="registrationNumber">Registration Number</Label>
                    <Input id="registrationNumber" name="registrationNumber" defaultValue={vehicle?.registrationNumber} required placeholder="KA-01-AB-1234" />
                </div>
                <div className="space-y-2">
                ...
                <div className="space-y-2">
                    ...
                    <Input id="pricePerDay" name="pricePerDay" type="number" defaultValue={vehicle?.pricePerDay} required placeholder="2000" min="0" />
                </div>
                <div className="space-y-2">
                ...
                <div className="space-y-2">
                    ...
                    <Input id="mileage" name="mileage" type="number" defaultValue={vehicle?.mileage} placeholder="15" min="0" step="0.1" />
                </div>
            </div>
...
function SubmitButton({ isEdit }: { isEdit: boolean }) {
    ...
    return (
        <Button type="submit" disabled={pending} className="min-w-[120px]">
            {pending ? (isEdit ? "Updating..." : "Creating...") : (isEdit ? "Update Vehicle" : "Create Vehicle")}
        </Button>
    );
}
