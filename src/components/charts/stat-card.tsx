...
export function StatCard({
  ...
  return (
    <Card
      className={cn(
        "relative overflow-hidden bg-white dark:bg-slate-900 border-[#E8E5F0] dark:border-slate-800 shadow-sm hover:shadow-md transition-shadow duration-200",
        className,
      )}
    >
      <CardContent className="p-5">
        <div className="flex items-start justify-between">
          <div className="space-y-2">
            ...
            <p className="text-2xl font-semibold text-[#1a1d2e] dark:text-white tracking-tight">
              {value}
            </p>
            {(description || trend) && (
