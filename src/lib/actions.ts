...
export async function updateCustomer(id: string, formData: FormData) {
  ...
  if (aadharUrl) {
    ...
    if (
      existingCustomer?.aadharImagePublicId &&
      existingCustomer.aadharImagePublicId !== aadharPublicId
    ) {
  ...
  if (licenseUrl) {
    if (
      existingCustomer?.drivingLicenseImagePublicId &&
      existingCustomer.drivingLicenseImagePublicId !== licensePublicId
    ) {
