            ...
            <div className="space-y-4">
              {upcomingReturns.length === 0 ? (
                ...
                upcomingReturns.map((booking) => {
                  ...
                  const daysLeft = now
                    ? Math.ceil(
                        (new Date(booking.dropDate).getTime() - now) /
                          (1000 * 60 * 60 * 24),
                      )
                    : 0;
                      ...
                      <div className="text-right">
                        <Badge
                          ...
                          className={
                            daysLeft <= 0
                              ? ""
                              : "bg-blue-100 dark:bg-blue-950/40 text-blue-700 dark:text-blue-400 hover:bg-blue-200 dark:hover:bg-blue-950/60"
                          }
                        >
            ...
            <TableBody>
              {recentBookings.map((booking) => {
                ...
                return (
                  <TableRow
                    key={booking.id}
                    className="hover:bg-slate-50/50 dark:hover:bg-slate-800/30 border-b border-slate-50 dark:border-slate-800 last:border-0"
                  >
      ...
      <CardContent className="p-6">
        <div className="flex items-center justify-between mb-4">
          ...
          {trend && (
            <Badge
              variant="outline"
              className={`${trendUp ? "text-emerald-600 bg-emerald-50 dark:bg-emerald-950/30 border-emerald-200 dark:border-emerald-800" : "text-red-600 bg-red-50 dark:bg-red-950/30 border-red-200 dark:border-red-800"}`}
            >
              {trend}
            </Badge>
          )}
