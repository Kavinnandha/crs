    ...
    <div className="flex items-center gap-2">
      <Select value={statusFilter} onValueChange={setStatusFilter}>
        ...
        <SelectContent className="rounded-xl border-[#E8E5F0] dark:border-slate-700 shadow-lg">
          ...
          <SelectItem value="Reserved" className="rounded-lg">
            Reserved
          </SelectItem>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredBookings.map((booking) => {
            ...
            return (
              <Card
                key={booking.id}
                className="group relative overflow-hidden bg-card hover:shadow-md transition-all"
              >
                  ...
                  <div className="space-y-1.5 p-2 bg-muted/40 rounded-md border text-xs">
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium">
                        {pickup.toLocaleDateString("en-IN", {
                          month: "short",
                          day: "numeric",
                          hour: "2-digit",
                          minute: "2-digit",
