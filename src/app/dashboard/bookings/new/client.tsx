...
export default function NewBookingClient({ vehicles, customers, bookings }: NewBookingClientProps) {
    ...
    async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
        ...
        if (calculation) {
            ...
            form.append("charges", JSON.stringify({
                ...
                <CardContent>
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="space-y-2">
                            ...
                            <Select name="customerId" required onValueChange={(v) => setFormData({ ...formData, customerId: v })}>
                                <SelectTrigger>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="space-y-2">
                                ...
                                <Input type="datetime-local" name="pickupDate" required onChange={(e) => setFormData({ ...formData, pickupDate: e.target.value })} />
                            </div>

                            <div className="space-y-2">
                                <Label htmlFor="dropDate">Drop Date & Time</Label>
                                <Input type="datetime-local" name="dropDate" required onChange={(e) => setFormData({ ...formData, dropDate: e.target.value })} />
                            </div>
                        </div>

                        <div className="space-y-2">
                            <Label htmlFor="vehicleId">Vehicle</Label>
                            <Select name="vehicleId" required onValueChange={(v) => setFormData({ ...formData, vehicleId: v })}>
                                <SelectTrigger>
