                    ...
                    <form action={handleSubmit} className="space-y-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="space-y-2">
                                ...
                                <Select name="serviceType" defaultValue={record.serviceType} required>
                                    <SelectTrigger>
                            ...
                            <div className="space-y-2">
                                ...
                                <Input
                                    type="date"
                                    name="serviceDate"
                                    defaultValue={record.serviceDate ? new Date(record.serviceDate).toISOString().split('T')[0] : ''}
                                    required
                                />
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="space-y-2">
                                ...
                                <Input type="number" name="cost" defaultValue={record.cost} required min="0" />
                            </div>
                            ...
                            <div className="space-y-2">
                                ...
                                <Input
                                    ...
                                    defaultValue={record.nextServiceDate ? new Date(record.nextServiceDate).toISOString().split('T')[0] : ''}
                                />
                            </div>
                        </div>
