          ...
          <Table>
            <TableHeader>
              <TableRow className="bg-muted/50 border-border">
                <TableHead className="font-semibold text-[#64748B] dark:text-slate-400">
                  Admin
                </TableHead>
                <TableHead className="font-semibold text-[#64748B] dark:text-slate-400">
                  Email
              ...
              {admins.length === 0 ? (
                ...
                admins.map((admin) => (
                  ...
                  >
                    ...
                    <TableCell className="text-sm text-[#64748B] dark:text-slate-400">
                      {admin.email}
                    </TableCell>
                    <TableCell>
                      <Badge
                      ...
                      <DropdownMenu>
                        ...
                        >
                          <DropdownMenuItem asChild>
                            <Link
                              href={`/dashboard/admins/${admin._id}/edit`}
