    ...
    return (
        <div className="max-w-2xl mx-auto space-y-6">
            <div className="flex items-center gap-4">
                ...
                <h1 className="text-2xl font-bold tracking-tight text-[#1a1d2e] dark:text-white">Add New Admin</h1>
            </div>

            <Card className="border-[#E8E5F0] dark:border-slate-800 shadow-sm bg-white dark:bg-slate-900">
                <CardHeader>
                    <CardTitle className="text-[#1a1d2e] dark:text-white">Admin Details</CardTitle>
                </CardHeader>
                <CardContent>
                    <AdminForm
