      ...
      {viewMode === "table" ? (
            ...
            <Table>
              <TableHeader>
                <TableRow className="bg-muted/50 border-border">
                  <TableHead className="font-semibold text-[#64748B]">
                    Customer
                  </TableHead>
                  <TableHead className="font-semibold text-[#64748B]">
                    Phone
                ...
                {filteredCustomers.length === 0 ? (
                  ...
                  filteredCustomers.map((customer) => (
                    ...
                    >
                      ...
                      <TableCell className="text-sm text-[#1a1d2e] dark:text-slate-200">
                        {customer.phone}
                      </TableCell>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {filteredCustomers.map((customer) => (
            <Card
              key={customer.id}
              className="group relative overflow-hidden transition-all hover:shadow-md border border-border rounded-2xl"
            >
              <CardContent className="p-6">
                ...
                <div className="flex flex-col items-center text-center">
                  ...
                  <Link
                    ...
                    className="hover:underline"
                  >
                    <h3 className="font-semibold text-lg text-[#1a1d2e] dark:text-white">
                      {customer.name}
                    </h3>
                  </Link>
                  ...
                  <div className="w-full space-y-3 mt-2 pt-4 border-t border-border text-sm">
                    <div className="flex items-center justify-between text-[#94a3b8]">
                      ...
                      <span className="text-[#1a1d2e] dark:text-slate-200 font-medium">
                        {customer.phone}
                      </span>
                    </div>
                    <div className="flex items-center justify-between text-[#94a3b8]">
                      ...
                      <span className="text-[#1a1d2e] dark:text-slate-200 font-medium font-mono text-xs">
                        {customer.drivingLicenseNumber}
                      </span>
                    </div>
                    <div className="flex items-center justify-between text-[#94a3b8]">
                  ...
                  >
                    <Button
                      variant="outline"
                      className="w-full mt-4 rounded-xl border-border text-muted-foreground hover:text-foreground hover:bg-muted"
                    >
                      View Profile
                    </Button>
                  </Link>
